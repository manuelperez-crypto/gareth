...
export const HeroButton = React.forwardRef<HTMLButtonElement, HTMLMotionProps<"button">>(
  ({ className, transition, ...props }, ref) => (
    <motion.button
      ...
      ref={ref}
      className={cn(
        "group relative flex w-fit items-center rounded-full border border-[#f59e0b] bg-[#f59e0b]/10 px-6 py-2.5 text-sm font-bold text-[#f59e0b] shadow-[0px_4px_24px_rgba(245,158,11,0.3)] transition-colors hover:bg-[#f59e0b]/20",
        className
      )}
      {...props}
    />
